...
try:
    if os.path.exists('svm_model.pkl'):
        ...
        print("Warning: svm_model.pkl not found. Using mock predictions.")
...
def status():
    ...
    return jsonify({
        ...
        'status': 'running',
        'model_loaded': model_loaded,
        'model_file_exists': os.path.exists('svm_model.pkl'),
...
if __name__ == '__main__':
    ...
    print(f"Model file exists: {os.path.exists('svm_model.pkl')}")
